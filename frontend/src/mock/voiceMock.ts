...
export const selectors = {
  ...
  computeKPIs: (leads: LeadProfile[]) => {
    ...
    return { totalLeads, hotLeads, warmLeads, coldLeads, avgLeads, converted, unconverted, pendingDecisions, avgScore, demoBooked: 0, callbacks: 0, failedCalls: 0, eligibleLeads: 0, nonEligibleLeads: 0, notInterestedLeads: 0 };
  },
